(function($) {
  ...
  var proCata = $(".dstyle-pro-catagory");
  ...
  var dstyleSearch = $(".search-nav");
  var searchClose = $(".search-close");

  dstyleSearch.on("click", function() {
  ...
  var dstyleMobNav = $(".dstyle-navbar-toggler");
  var navClose = $(".nav-close");

  dstyleMobNav.on("click", function() {
